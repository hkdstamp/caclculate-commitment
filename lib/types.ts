...
export interface CommitmentCostResult {
  ...
  ri_insurance_30d: number; // 30日コミットメント保証スマート予約利用料
  ri_insurance_1y: number; // 1年コミットメント保証スマート予約利用料
...
export interface CalculationParams {
  ...
  insurance_rate_30d: number; // 30日コミットメント保証のスマート予約利用料率 (デフォルト 0.5)
  insurance_rate_1y: number; // 1年コミットメント保証のスマート予約利用料率 (デフォルト 0.3)
